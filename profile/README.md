...
#### Variant Calling & Discovery
- **call-germline-variants**: Call germline variants from BAM files using GATK HaplotypeCaller
...
- **demultiplex-bcl-files**: Demultiplex Illumina BCL files and convert to FASTQ
- **convert-file-formats**: Convert between genomic data formats (VCF, BAM, BED, etc.)
- **download-source-files**: Download and organize reference files and annotation databases
- **query-alphagenome-api**: Query AlphaGenome API for variant effect predictions
...
- **genomictools/**: Shared R package with utility functions
